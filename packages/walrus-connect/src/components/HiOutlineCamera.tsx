// https://github.com/tailwindlabs/heroicons/blob/master/src/24/outline/camera.svg

import React from 'react';

interface HiOutlineCameraProps extends React.SVGProps<SVGSVGElement> {}

export const HiOutlineCamera: React.FC<HiOutlineCameraProps> = ({
  className,
  ...props
}) => {
  return (
